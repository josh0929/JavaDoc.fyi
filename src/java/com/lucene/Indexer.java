...
public class Indexer
{
	...
	public Indexer(String indexDirectoryPath, String dataDirectoryPath) throws IOException
	{

		//This directory will contain the indexes
		BaseDirectory indexDirectory = FSDirectory.open(Paths.get(indexDirectoryPath));
		...
		indexDocs(writer, Paths.get(dataDirectoryPath));
	}
		   ...
		   throws IOException
	{
		try (InputStream stream = Files.newInputStream(file))
		{
			...
			// "modified". Use a LongPoint that is indexed (i.e. efficiently 
			// filterable with PointRangeQuery). This indexes to milli-second
			// resolution, which is often too fine. You could instead create 
			// a number based on year/month/day/hour/minutes/seconds, down 
